...
const createAcademicSemesterZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        startMonth: zod_1.z.enum([...academicSemester_constant_1.academisSemesterMonths], {
            required_error: 'Start Month is required',
        }),
        endMonth: zod_1.z.enum([...academicSemester_constant_1.academisSemesterMonths], {
...
const updateAcademicSemesterZodSchema = zod_1.z
    ...
    (!data.body.title && !data.body.code), { message: 'Either both title and code should be provided or neither' });
